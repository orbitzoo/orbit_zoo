# --- Compatibility shim for play3d (built for Python < 3.10) ---
# play3d 0.1.5 does `from collections import Iterable`, but the ABCs were moved to
# collections.abc in Python 3.10. Re-expose them on `collections` so play3d (and
# interface_models, which also imports play3d) import on modern Python.
import collections
import collections.abc
for _abc in ('Iterable', 'Mapping', 'MutableMapping', 'Sequence', 'Callable', 'Hashable'):
...
from orbitzoo.dynamics.orekit.constants import EARTH_RADIUS, MU, ATTITUDE, INERTIAL_FRAME
...
from orbitzoo.interface.interface_models import Trail, Point, EarthSurface
from orbitzoo.interface.pygame_utils import handle_camera_with_keys
